...
### Running Baexandra Locally

You can start baexandra locally by running:
...
Then you can interact with baexandra by typing `baexandra help`.

    baexandra> baexandra help
    baexandra animate me <query> - The same thing as `image me`, except adds [snip]
    baexandra help - Displays all of the help commands that baexandra knows about.
    ...
