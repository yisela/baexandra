...
module.exports = (robot) ->  
  ...
  robot.hear /Styleguide/, (res) ->
    res.send "I knew you couldn't wait. Unfortunately, I'm a very limited bot, so for now I can just tell you where to get the Styleguide: http://tinyurl.com/hag6kuq. Let's pretend we just went through the document and move on, shall we? Type *Continue*."
